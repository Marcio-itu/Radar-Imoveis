...
async function buscarZyte(url, apiKey, opcoes = {}) {
  ...
  if (opcoes.renderJs && typeof dados.browserHtml === "string") {
    return dados.browserHtml;
  }
  if (typeof dados.httpResponseBody === "string") {
    return Buffer.from(dados.httpResponseBody, "base64").toString("utf-8");
  }
  throw new Error("Zyte: resposta sem HTML reconhecível");
}
